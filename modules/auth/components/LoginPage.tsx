    ...
    <div className="min-h-screen w-full max-w-[100vw] overflow-x-hidden bg-slate-950 text-white antialiased">
      ...
      <main className="relative flex min-h-[calc(100vh-4rem)] w-full items-center justify-center px-4 py-16 sm:px-6 sm:py-20">
        ...
        <div className="relative w-full max-w-[420px]">
          <div className="rounded-2xl border border-white/10 bg-slate-800/60 p-8 shadow-2xl shadow-black/30 backdrop-blur sm:p-10">
            <h1 className="font-display text-center text-2xl font-bold tracking-tight text-white sm:text-3xl">
              Acceso al sistema
            </h1>
